...
data.frame() %>% ggplot()+
  ...
  geom_ribbon(aes(x = xs, ymin = ys-se_slope, ymax = ys+se_slope), fill = "blue", alpha =  0.5)+
  geom_ribbon(aes(x = xs, ymin = ys-se_slope-sigma, ymax = ys+se_slope+sigma), fill = "lightblue", alpha =  0.5)
