...
generated quantities{
  ...
  real resid_alpha_var = sum(square(real_alpha-alpha))/(P*S);
  real resid_lambda_var = sum(square(real_lambda-lambda))/(P*S);
  real resid_beta_var = sum(square(real_beta-beta))/(P*S);
